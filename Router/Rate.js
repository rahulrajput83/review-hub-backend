...
router.put('/rate', verify, (req, res) => {
    MoviesModel.updateOne({_id: req.body.movieId}, {$set: {"rating": req.body.rating}, $push: {"rated": {user: {_id: req.user._id, userName: req.body.userName}, rating: req.body.rated}}})
    .then(() => {
